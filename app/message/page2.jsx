...
export default function page() {
    ...
    async function sendMessage(formData) {
        ...
        data = { id: messages.at(-1).id + 1, message: message };                   // think it as this data is returned from server
    ...
    return (
        <>
            {optimisticMessages.map((message, i) => <Message key={message.id} message={message} />)}
